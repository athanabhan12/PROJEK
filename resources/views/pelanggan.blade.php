        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <button type="button" style="float: right;" class="btn btn-primary ml-3 mr-3" data-toggle="modal" data-target="#importExcel">
                IMPORT EXCEL
              </button>
              <a href="{{ url('pelanggan/pdf') }}" target="_blank" class="btn btn-danger" style="float: right;"><i class="fa-solid fa-plus ml-2"></i>Export PDF</a>
                ...
                <table id="basic-datatables" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td>
                          <div>
                          {!! QrCode::size(100)->generate($pelanggan->nama_peserta. ',' .$pelanggan->kelas) ;!!}
                        </div>    
                        </td>
